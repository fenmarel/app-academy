...
ActiveRecord::Schema.define(version: 20140309033417) do
  ...
  add_index "friendships", ["follower_id", "followed_user_id"], name: "index_friendships_on_follower_id_and_followed_user_id", unique: true, using: :btree
